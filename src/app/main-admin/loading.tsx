  ...
  return (
    <div className="w-full min-h-[60vh] flex flex-col items-center justify-center p-6 space-y-4 select-none animate-in fade-in duration-300">
      ...
      <div className="space-y-1 text-center animate-pulse">
        <h4 className="text-xs font-bold font-mono text-foreground tracking-wide">Loading System Console...</h4>
        <p className="text-[10px] text-muted-foreground font-sans">Connecting to Campus Codex main cluster</p>
      </div>
    </div>
  );
}
