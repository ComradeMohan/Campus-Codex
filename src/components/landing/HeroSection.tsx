      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="grid gap-8 md:grid-cols-2 md:items-center">
          <div className="space-y-6">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl font-headline text-foreground dark:text-white">
              Master Programming with Interactive Labs
            </h1>
            <p className="text-lg text-muted-foreground dark:text-gray-200 md:text-xl">
